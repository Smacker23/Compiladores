...
public class SolLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "RETURN", "VAR", "IF", "ELSE", "THEN", "EQUAL", "COMMA", "BREAK", 
			"WHILE", "DO", "FOR", "TO", "BEGIN", "END", "MOD", "LPARENT", "RPARENT", 
			"PRINT", "SEMICON", "MULT", "DIVISAO", "ADD", "MENOS", "INT", "DOUBLE", 
			"STRING", "BOOL", "WS", "RELACIONAL", "IDUALDADE", "ELOGICO", "OULOGICO", 
			"NOT", "VARNAME", "SL_COMMENT", "ML_COMMENT"
		};
	}
